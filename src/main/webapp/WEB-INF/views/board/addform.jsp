		...
		<div id="content">
			<div class="content_wrap">
				<div class="title"><h2>NOTICE</h2></div>
					<div class="addform">
						<form action="${path1 }/board/addboard.do" method="post">
							<table class="table">
								<tbody>
									<tr>
										<th><label for="title">제목</label></th>
										<td><input type="text" name="btitle" id="title" size="100" class="single100" placeholder="글제목 입력" required></td>
									</tr>
									<tr>
										<th><label for="exampleTextarea1" class="form-label">글 내용</label></th>
										<td><textarea class="form-control" name="bcontent" id="ckeditor" rows="6"></textarea></td>
									</tr>
									<tr>
