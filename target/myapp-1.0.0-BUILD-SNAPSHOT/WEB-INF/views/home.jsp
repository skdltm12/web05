            ...
            <div class="event_col2">
                ...
                <div class="event_col2_product">
                    ...
                    <c:forEach items="${premiumList }" var="prL" varStatus="status">
                        <ul>
                            ...
                            <li class="product_img">
                            	<a href="${path1 }/product/read.do?p_id=${prL.pid }"><img src="./resources/upload/${prL.pimg }" alt="제품사진"></a>
				               <c:if test="${prL.dc != 0 }">
				                   	<p class="product_dc">${prL.dc }%</p>
				               </c:if>
				           </li>                    
                            <li class="product_name"><a href="${path1 }/product/read.do?p_id=${prL.pid }">${prL.pname }</a></li>
					...
					<c:forEach items="${denimlist }" var="dl" varStatus="status">
                        <ul>
                            <li class="best_product">BEST ${status.count }</li>
                            <li class="product_img"><a href="${path1 }/product/read.do?p_id=${dl.pid }"><img src="./resources/upload/${dl.pimg }" alt="제품사진"></a>
          		               <c:if test="${dl.dc != 0 }">
				                   	<p class="product_dc">${dl.dc }%</p>
				               </c:if>
                            </li>  
                            <li class="product_name"><a href="${path1 }/product/read.do?p_id=${dlp_id }">${dl.pname }</a></li>         
					...
					<c:forEach items="${wovenlist }" var="wl" varStatus="status">
                        <ul>
                            <li class="best_product">BEST ${status.count }</li>
                            <li class="product_img"><a href="${path1 }/product/read.do?p_id=${wl.pid }"><img src="./resources/upload/${wl.pimg }" alt="제품사진"></a>
                               <c:if test="${wl.dc != 0 }">
				                   	<p class="product_dc">${wl.dc }%</p>
				               </c:if>
                            </li>  
                            <li class="product_name"><a href="${path1 }/product/read.do?p_id=${wlp_id }">${wl.pname }</a></li>         
					...
					<c:forEach items="${acclist }" var="al" varStatus="status">
                        <ul>
                            <li class="best_product">BEST ${status.count }</li>
                            <li class="product_img"><a href="${path1 }/product/read.do?p_id=${al.pid }"><img src="./resources/upload/${al.pimg }" alt="제품사진"></a>
                            	<c:if test="${al.dc != 0 }">
				                   	<p class="product_dc">${al.dc }%</p>
				               </c:if>
                            </li>  
                            <li class="product_name"><a href="${path1 }/product/read.do?p_id=${al.pid }">${al.pname }</a></li>         
            ...
            <div>
                <div class="product_list">
	                <c:forEach items="${productList }" var="pl" varStatus="status">            
	                    <ul>
	                        <li class="product_img"><a href="${path1 }/product/read.do?p_id=${pl.pid }"><img src="./resources/upload/${pl.pimg }" alt="제품사진"></a>
	     	                   <c:if test="${pl.dc != 0 }">
				                   	<p class="product_dc">${pl.dc }%</p>
				               </c:if>
	                        </li>                    
	                        <li class="product_name"><a href="${path1 }/product/read.do?p_id=${pl.pid }">${pl.pname }</a></li>
