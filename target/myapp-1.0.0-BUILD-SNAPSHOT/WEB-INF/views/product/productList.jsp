						...
						<div class="menu_wrap">
					        ...
					        <div class="product_inner">
								...
								<c:if test="${pcode=='14' || pcode=='16' ||pcode=='18' || pcode=='22'  }">
								    <a href="${path1 }/product/list.do?p_id=14">JUMPER/VEST</a>
					                <a href="${path1 }/product/list.do?p_id=16">T-SHIRTS/SHIRTS</a>
					                <a href="${path1 }/product/list.do?p_id=18">PANTS/SHORTS</a>
					                <a href="${path1 }/product/list.do?p_id=20">DENIM</a>
					                <a href="${path1 }/product/list.do?p_id=22">DRESS/SKIRT</a>             
					              </c:if>
								<c:if test="${pcode=='24' || pcode=='26' ||pcode=='28' }">
								    <a href="${path1 }/product/list.do?p_id=24">JUMPER/VEST</a>
					                <a href="${path1 }/product/list.do?p_id=26">T-SHIRTS/SHIRTS</a>
					                <a href="${path1 }/product/list.do?p_id=28">PANTS/SHORTS</a>
					                <a href="${path1 }/product/list.do?p_id=30">DENIM</a>                            
					              </c:if>              
				            ...
				            <c:forEach items="${productList }" var="product" varStatus="status">
				                <ul>
				                    <li class="product_img"><a href="${path1 }/product/read.do?p_id=${product.p_id }"><img src="../resources/upload/${product.p_img }" alt="제품사진"></a>
				                    <c:if test="${product.dc != 0 }">
				                    	<p class="product_dc">${product.dc }%</p>
				                    </c:if>
				                    </li>                    
				                    <li class="product_name"><a href="${path1 }/product/read.do?p_id=${product.p_id }">${product.p_name }</a></li>
				                    <li class="product_price"><fmt:formatNumber value="${product.p_price }" pattern="##,###"/>원</li>
				                    <li class="product_dcp"><fmt:formatNumber value="${product.p_dcprice }" pattern="##,###"/>원</li>				                    
				                </ul>
				            </c:forEach>
				            </div>
						</div>
