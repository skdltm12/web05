	...
	<div class="content_wrap">
        <div class="product_wrap">
                <div class="product_imgbox">
                    <img src="../resources/upload/${productRead.p_img }" alt="이미지1">
                </div>   
                <div class="product_infobox">
                    <form action="${path1 }/basket/addbasket.do" method="post" name="form">
                        <table class="tb4">                        
                            ...
                            <tr  class="tb4_price">
                                <td colspan="2"><fmt:formatNumber value="${productRead.p_price }" pattern="##,###"/>원</td>
                            </tr>
                            <tr class="tb4_tr1">
                                <th class="">판매가</th><td><fmt:formatNumber value="${productRead.p_dcprice }" pattern="##,###"/>원</td>
                            </tr>
                            <tr class="tb4_tr2">
                            ...
                            <tr class="tb4_color"><th>색상</th>
                                <td><input type="hidden" value="" id="color">
                                    <select name="bs_color" onchange="fnc2()" id="color">
                                    <option> - [필수] 옵션을 선택해 주세요 -</option>
                                        <option disabled >--------------</option>
                                        <option value="${productRead.p_color }">${productRead.p_color }</option>
                                    </select>
                                </td>
                            </tr>
                            <tr class="tb4_size"><th>사이즈</th>
                                <td><input type="hidden" value="" id="size">
                                    <select name="bs_size" onchange="fnc3()" id="size">
                                    <option> - [필수] 옵션을 선택해 주세요 -</option>
                                        <option disabled >--------------</option>
                                        <option value="${productRead.p_size }">${productRead.p_size }</option>
                                    </select>
                                </td>
                            </tr>
                            <tr class="amount">
                            ...
                            <tr class="show" id="show">
                                <td colspan="2"><c>${productRead.p_name }<br><d>-${productRead.p_color }/${productRead.p_size }</d></c><input type="number" value="1" id="bs_amount" name="bs_amount" min="1" max="${productRead.p_amount }" onchange="fnc4()">
                                    <a><img src="../resources/img/btn_price_delete.gif" alt=""></a>
                                    <b><fmt:formatNumber value="${productRead.p_dcprice }" pattern="##,###"/>원</b></td>                                    
                            </tr>
                            <tr class="tp">
                                <th></th>
                            ...
                            <tr class="tb4_button">                                
                                ...
                                <input type="hidden" value="${productRead.p_id }" name="bs_id">
                                <input type="hidden" value="${sid }" name="bs_uid" id="sid">                                
                                <input type="hidden" value="${productRead.p_size }" name="bs_size">
                                <input type="hidden" value="${productRead.p_name }" name="bs_name">
                                <input type="hidden" value="${productRead.p_price }" name="bs_price">
                                <input type="hidden" value="${productRead.p_dcprice }" name="bs_dcprice">
                                <input type="hidden" value="${productRead.p_img }" name="bs_img">                                
                            <c:if test="${sid==null }">
    ...
    <script>
        ...
        function fnc3(){
            ...
            if(color=='ck' && size =='ck'){
                ...
                var totalprice = amount*${productRead.p_dcprice }; 
        ...
        <c:if test="${sid=='admin' }">
			<form action="${path1 }/product/update.do" method="post">		
				<table class="tb2">
					<tr>
						<th>제품코드</th>					
						<td><input type="text" value="${productRead.p_id }" name="p_id"></td>			
					</tr>
					<tr>
						<th>제품명</th>					
						<td><input type="text" value="${productRead.p_name }" name="p_name"></td>		
					</tr>
					<tr>
						<th>가격</th>					
						<td><input type="text" value="${productRead.p_price }" name="p_price"></td>
					</tr>
					<tr>
						<th>할인가격</th>					
						<td><input type="text" value="${productRead.p_dcprice }" name="p_dcprice"></td>				
					</tr>
					<tr>
						<th>이미지</th>					
						<td><input type="text" value="${productRead.p_img }" name="p_img"></td>	
					</tr>
					<tr>
						<th>색상</th>					
						<td><input type="text" value="${productRead.p_color }" name="p_color"></td>
					</tr>
					<tr>
						<th>사이즈</th>					
						<td><input type="text" value="${productRead.p_size }" name="p_size"></td>
					</tr>
					<tr>
						<th>수량</th>					
						<td><input type="text" value="${productRead.p_amount }" name="p_amount"></td>
					</tr>
					<tr>
						<th>판매량</th>					
	...
	<script>  	
    	function deleteproduct(){
    		if(confirm("정말 상품을 삭제할까요?")){
    			location.href='${path1 }/product/delete.do?p_id=${productRead.p_id }';
    		}
    	}
    	</script>
</div>	
