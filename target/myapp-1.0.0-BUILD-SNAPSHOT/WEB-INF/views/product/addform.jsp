		...
		<div class="content_wrap">
			...
			<form action="${path1 }/product/add.do" method="post" enctype="multipart/form-data">
				<table class="tb tb6">
					<tr>
						<th>제품번호</th>
						<td><input type="text" name="p_id" class="single100"></td>
					</tr>
					<tr>
						<th>제품명</th>
						<td><input type="text" name="p_name" class="single100"></td>
					</tr>
					<tr>
						<th>상품가격</th>
						<td><input type="text" name="p_price" class="single100"></td>
					</tr>
					<tr>
						<th>할인가격</th>
						<td><input type="text" name="p_dcprice" class="single100"></td>
					</tr>
					<tr>
						<th>이미지</th>
						<td><input type="file" name="p_img" id="p_img" class="single100"></td>
					</tr>
					<tr>
						<th>색상</th>
						<td><input type="text" name="p_color" class="single100"></td>
					</tr>
					<tr>
						<th>사이즈</th>
						<td><input type="text" name="p_size" class="single100"></td>
					</tr>
					<tr>
						<th>수량</th>
						<td><input type="text" name="p_amount" class="single100"></td>
					</tr>
					<tr>
